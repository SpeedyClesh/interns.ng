            ...
            <div class="col-xs-12 col-md-4 col-md-offset-4" style="margin-top:150px">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                            <form action="" method="post" action="login_comp.php">
                                ...
                                <div class="form-group">
                                    <input class="btn btn-info" type="submit" name="comp_user" value="LOGIN" id="button">
                                </div>
                                </div>
                                <div class="form-group">
                                    <a href="#"><label>Forget Password?</label></a>
                                    <a href="signup_comp.php"><label>SIGN UP</label></a>
                                </div>
                            </form>
                    </div>
                </div>
